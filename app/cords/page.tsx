    ...
    powerCordsTable: [
      {
        ...
        pdf: `${process.env.NEXT_PUBLIC_S3_BUCKET_HOSTNAME}/PPF-Tech-Power-Cord-Specifications_R2.0.pdf`,
      },
      {
        model: 'PC-14G-6-220',
    ...
    controlCordsTable: [
      {
        ...
        pdf: `${process.env.NEXT_PUBLIC_S3_BUCKET_HOSTNAME}/PPF-Tech-Control-Cord-Specifications_R1.0.pdf`,
      },
      {
        model: 'CC-10-1',
      ...
      },
      {
        ...
        pdf: `${process.env.NEXT_PUBLIC_S3_BUCKET_HOSTNAME}/PPF-Tech-RJ-M16-Specifications_R4.0.pdf`,
      },
    ],
  }
